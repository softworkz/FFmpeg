...
static int config_output(AVFilterLink *outlink)
{
    ...
    f_outlink->frame_rate = f_inlink->frame_rate;
...
const FFFilter ff_sf_textmod = {
    .p.name          = "textmod",
    .p.description   = NULL_IF_CONFIG_SMALL("Modify subtitle text in several ways"),
    .p.priv_class    = &textmod_class,
    .init          = init,
    .uninit        = uninit,
...
const FFFilter ff_sf_censor = {
    .p.name          = "censor",
    .p.description   = NULL_IF_CONFIG_SMALL("Censor words in subtitle text"),
    .p.priv_class    = &censor_class,
    .init          = init_censor,
    .uninit        = uninit,
    .priv_size     = sizeof(TextModContext),
    FILTER_INPUTS(inputs),
...
const FFFilter ff_sf_showspeaker = {
    .p.name          = "showspeaker",
    .p.description   = NULL_IF_CONFIG_SMALL("Prepend speaker names to text subtitles (when available)"),
    .p.priv_class    = &showspeaker_class,
