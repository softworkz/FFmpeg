...
/*
 * These struct types intentionally use double fields instead of AVRational,
 * unlike the similarly named types in libavutil/csp.h (AVLumaCoefficients,
 * AVPrimaryCoefficients, AVWhitepointCoefficients). This is a deliberate
 * performance trade-off for the SIMD hot paths in the supertonemap filter.
 */
...
typedef struct TonemapContext {
    ...
    DECLARE_ALIGNED(16, float,  rgb2rgb_coeffs)[3][3];
} TonemapContext;
