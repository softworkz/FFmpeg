...
extern const FFFilter ff_vf_overlaygraphicsubs;
extern const FFFilter ff_vf_overlaytextsubs;
...
extern const FFFilter ff_svf_graphicsub2video;
extern const FFFilter ff_svf_textsub2video;
