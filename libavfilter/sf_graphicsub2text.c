...
const FFFilter ff_sf_graphicsub2text = {
    .p.name          = "graphicsub2text",
    .p.description   = NULL_IF_CONFIG_SMALL("Convert graphical subtitles to text subtitles via OCR"),
    .p.priv_class    = &graphicsub2text_class,
    .init          = init,
    .uninit        = uninit,
