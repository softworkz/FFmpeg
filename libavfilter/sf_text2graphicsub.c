...
const FFFilter ff_sf_text2graphicsub = {
        .p.name            = "text2graphicsub",
        .p.description     = NULL_IF_CONFIG_SMALL("Convert text subtitles to bitmap subtitles."),
        .p.priv_class      = &text2graphicsub_class,
        .init            = init,
        .uninit          = uninit,
